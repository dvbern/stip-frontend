...
import { GesuchAppFeatureGesuchFormEinnahmenkostenComponent } from './gesuch-app-feature-gesuch-form-einnahmenkosten/gesuch-app-feature-gesuch-form-einnahmenkosten.component';
    ...
    children: [
      {
        ...
        component: GesuchAppFeatureGesuchFormEinnahmenkostenComponent,
      },
